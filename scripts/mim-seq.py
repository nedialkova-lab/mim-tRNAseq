...
# Main wrapper
	...
	cons_mod_pos, mod_sites, cons_pos_list, cons_pos_dict = ssAlign.modContext(out)
	...
	modplot_cmd = "Rscript " + script_path + "/modPlot.R " + out + " " + str(cons_mod_pos) + " " + str(mod_sites) + " " + str(cons_pos_list) + " " + str(mito_trnas)
