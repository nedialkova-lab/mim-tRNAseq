...
if __name__ == '__main__':
	...
	inputs.add_argument('-t', '--trnas', metavar='genomic tRNAs', required = True, dest = 'trnas', help = \
		'Genomic tRNA fasta file, e.g. from gtRNAdb or tRNAscan-SE. Already avalable in data/ for a few model organisms. REQUIRED')
	...
	inputs.add_argument('-m', '--mito-trnas', metavar = 'mitochondrial tRNAs', required = False, dest = 'mito', \
		help = 'MItochondrial tRNA fasta file. Should be downloaded from mitotRNAdb for species of interest. Aready avaialable in data/ for a few model organisms.')
